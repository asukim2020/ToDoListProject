...
class SwipeBackgroundHelper {
    ...
    companion object {
        ...
        private var circlePaint: Paint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
            color = ItemApplication.getColor(R.color.red)
        }
        ...
        private fun createDrawCommand(viewItem: View, dX: Float, iconResId: Int): DrawCommand {
            ...
            icon.colorFilter = PorterDuffColorFilter(ItemApplication.getColor(R.color.background), PorterDuff.Mode.SRC_IN)
            return DrawCommand(icon, ItemApplication.getColor(R.color.background))
        }
